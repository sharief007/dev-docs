...
{{< cards >}}
    ...
    {{< card link="system-design" title="System Design Use Cases" subtitle="Real-world System Design Examples" >}}
    {{< card link="low-level-design" title="Low Level Design Problems" subtitle="Object-Oriented Design Challenges" >}}
    {{< card link="machine-learning" title="Machine Learning" subtitle="ML Algorithms and Implementations" >}}
{{< /cards >}}
