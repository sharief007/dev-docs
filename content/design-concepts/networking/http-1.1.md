...
- Each chunk is prefixed with its byte count in **hexadecimal**
- Body ends with a **zero-length chunk** (`0\r\n\r\n`)
...
> Pipelining is effectively dead. HTTP/2 multiplexing solves the same problem without ordering constraints.
