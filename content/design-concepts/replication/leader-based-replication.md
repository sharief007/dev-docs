...
{{< details title="The leader crashes. A follower with the latest data is promoted. But the old leader comes back online and has a write the new leader doesn't have. What happens?" closed="true" >}}
...
{{< details title="You configure fully synchronous replication — the leader waits for ALL followers to confirm. A single slow follower makes all writes slow. Is there a middle ground?" closed="true" >}}
